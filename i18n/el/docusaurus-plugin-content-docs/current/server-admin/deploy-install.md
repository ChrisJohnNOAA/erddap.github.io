...
4. Σε Linux, Mac, και Windows, __download [Erddap.war (στα Αγγλικά).](https://github.com/ERDDAP/erddap/releases/download/v2.31.0/ERDDAP-2.31.0.war) - Μέσα `tomcat/webapps` :

__Παροχή 2.31.0, 719.567.541 bytes, MD5=DB0AFDE1F441CA9262CB66291A1110D7, με ημερομηνία 2026-08-28
