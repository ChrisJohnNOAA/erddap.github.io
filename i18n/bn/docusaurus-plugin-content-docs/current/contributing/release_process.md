...
* ছবির ফাইলের তুলনা নিশ্চিত করুন (এর মানে হচ্ছে চলমান `GPS যাচাই` যদি আপনি ছবিটির কমপ্লুটেনশন গ্রুপ- এর উপর সীমা আরোপ করতে চান, তবে মনে রাখবেন যে জেটি পরীক্ষা চালিয়ে যেতে হবে) 
...
```
* প্রধান কনফিগারেশনের জন্য সুনির্দিষ্ট আপডেট নিশ্চিত করতে পরীক্ষাগুলি চালানো হবে (সুনির্দিষ্ট তথ্য ধারণ করে, যদিও এর মধ্যে অধিক গুরুত্বপূর্ণ কোনো বৈশিষ্ট্যও অন্তর্ভুক্ত করা হয় না) . . উল্লেখ্য, বহিস্থিত পরীক্ষার স্যুইটটি অত্যন্ত জটিল হতে পারে। ধীরAWS পরীক্ষা স্যুইটটি অনেক সময় নিতে পারে।
```
mvn verify
mvn verify -P external
mvn verify -P slowAWS
```
* ব্যবহার `পাইথন অনুবাদ /` প্রয়োজন হলে অনুবাদ আপডেট করতে হলে ।
...
পি- জি- পি ..content/ravde22... সার্দ্দীচ/ওয়ার/অথবা নম্বরের সংখ্যা যা- টি
  * ইন \\[ নিক্তি \\] /bin/ :
..start.
  * পরে ERDDAP একটি ওয়েব পেজ ফেরত এসেছে, \\[ নিক্তি \\] / ওয়েব-সাইট // :
chip -radraplase
chmod -R+rwerusp
chmod -ro-rowaarde
...
* ডিরেক্টরি মুছে ফেলুন (উপস্থিত ফাইল মুছে নতুন করে লিখুন) এবং চলমান `পি. এস. ই. চালানো হচ্ছে` নতুন ফুটার-এ এক্সপোর্ট করুন।
* ডকুমেন্ট পরিদর্শন করুন (তদন্ত শুরু করো.) . .
  * অনুসন্ধান \\[ সার্দ্দি। \\]  
  * উপস্থিত তথ্য কপি করুন (পুনরায় লোড করা হয়েছে) পূর্ববর্তী ইনস্টলেশনের তালিকা
  * seravp এর জন্য বর্তমান রিলিজ তথ্য পরিবর্তন করুন । যুদ্ধ চলছে \\[ সার্দ্দি। \\] 
* নথিপত্রের জন্য ব্যবহারযোগ্য অনুবাদ সঞ্চালন করুন । এই পদক্ষেপটি খুব ধীর হতে পারে ।
  * ফুটার- এর নতুন সংস্করণ আছে কিনা তা নিশ্চিত হোন ।
...
আপনি যদি হয় ERDDAP এড্রেস, আপগ্রেডের নির্দেশ অনুযায়ী
 https://erddap.github.io/docs/server-admin/deploy-update
 

যদি আপনার কোন সমস্যা থাকে, প্রশ্ন, পরামর্শ দিন, আমাকে ইমেইল করুন।

ব্যবহারের জন্য ধন্যবাদ ERDDAP . .
