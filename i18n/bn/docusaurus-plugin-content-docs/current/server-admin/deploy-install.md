...
4. Linux, Mac ও Windows-র মধ্যে (_i) [সার্দ্দি।](https://github.com/ERDDAP/erddap/releases/download/v2.31.0/ERDDAP-2.31.0.war) চিহ্নিত স্থানে `চিহ্নিত প্রোগ্রাম সহযোগে খুলুন` :

২. ৩. ০, ৭.১৯, ৫৬৪১ বাইট, এম.ডি.৫-১ বাইট, এম. 32-০৮_8
