...
1.  [উল্লিখিত সময় অবধি ERDDAP™ v2. 0.0+, সেট Java ২৫.](#java) 
নিরাপত্তার কারণে, সাম্প্রতিক সংস্করণ ব্যবহার করা প্রায় সব সময় ভালো Java ২৫.
অনুগ্রহ করে নতুন সংস্করণ ডাউনলোড করুন
    [অ্যাডিয়ামের ওপেনJDK (তেভেত) ২৫ (কে- টাক্সName) ](https://adoptium.net/temurin/releases/?version=25) . .
ইনস্টলেশন পরীক্ষা করতে, চালনা `/javajebin ডিরেক্টরী/java - সংস্করণ` উদাহরণ হিসেবে:
    `/দূরবর্তী/local/jdk-২৫.0.1+8/bin/java - সংস্করণ` . .

    ERDDAP™ কর্ম Java অন্য উৎস থেকে, আমরা এডপিয়ামকে সুপারিশ করি কারণ এটা আমাদের প্রধান, কমিউনিটি সমর্থিত,
অবশিষ্ট (বিয়ার এবং ভাষণের মতো) সংস্করণ Java ২৫ যারা লংয়ের সমর্থন প্রদান করে (অনেক বছর আগে প্রাথমিক রিলিজের জন্য মুক্ত আপগ্রেড) . .
নিরাপত্তার কারণে অনুগ্রহ করে আপডেট পরীক্ষা করুন ERDDAP এর সংস্করণ Java নতুন সংস্করণ হিসাবে গণনা করা হবে Java এডোপিয়াম থেকে ২৫ জন পাওয়া যাবে।

    ERDDAP™ পরীক্ষা করা হয়েছে এবং ২৫,০০০ বার ব্যবহার করা হয়েছে অন্য কোন সংস্করণ ব্যবহার করা হয়নি। বিভিন্ন কারনে, আমরা অন্য সংস্করণের সাথে পরীক্ষা করি না বা সমর্থন করি না। Java . .
     
## টম্কক{#tomcat} 
...
যে ডিস্কটি ডিজাইন করা হয়েছে Java ২৫ বা নতুন। নীচে, টম্যাট ডিরেক্টরী উল্লেখ করা হবে `নিক্তি` . .
...
4. Linux, Mac ও Windows-র মধ্যে (_i) [সার্দ্দি।](https://github.com/ERDDAP/erddap/releases/download/v2.31.1/ERDDAP-2.31.1.war) চিহ্নিত স্থানে `চিহ্নিত প্রোগ্রাম সহযোগে খুলুন` :

২. ১.১, ৭১৯,৫৬১,৯৮২ বাইট, এম.ডি.৫ ফাইল: ২. 32-০৯_০৩
...
পূর্ববর্তী সংস্করণও পাওয়া যাচ্ছে।
   ...
   *  [২.২৯।](https://github.com/ERDDAP/erddap/releases/download/v2.29.0/erddap.war)   (৭০৬,৭৮৮,১৩৫ বাইট, এমডি৫ডিডি৫ডিডি৪৬৪৬৬ডিএসিবি৬৮৫৮৫৮৫-এর তারিখ।) 
   *  [২.৩০।](https://github.com/ERDDAP/erddap/releases/download/v2.30.0/ERDDAP-2.30.0.war)   (৭০৬,৯৩৯,১২১ বাইট, এমডিডি৫ডিবিডিবিডি২২০২-২০২০২০৩৩৩বিবিবি২৩২৩-৩২৩২৩২৩২৩৩২৩-৪৬-০৪-৪৬৪৩০, ০৪-০৪৪-৪৬-০৪৪, ০৪৪৩০-৪৬) 
...
প্রদর্শনের জন্য ব্রাউজার ব্যবহার করা হবে http://www.YourServer.org/erddap/status.html.
...
দেখুন https://en.wikipedia.org/wiki/Favicon.
