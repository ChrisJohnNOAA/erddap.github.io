...
## संस्करण 2.31.1{#version-2311} 
 (2026-09-03 जारी) 

*    **परिवर्तन** 
      * फिक्स [EDDTableFromMultidimNcFiles quarantine स्वस्थ स्रोत फ़ाइलों](https://github.com/ERDDAP/erddap/issues/556) । बुरा (या misbehaving) प्रश्नों को अब अच्छी फाइलों को क्वांटिन किया जाना चाहिए।

## संस्करण 2.31.0{#version-2310} 
 (2026-08-28 जारी) 

*    **नई सुविधाएँ और परिवर्तन (उपयोगकर्ताओं के लिए) :** 
      * एक फ़ाइल के रूप में उपलब्ध जानकारी आउटपुट प्रारूप के रूप में नया ncoJson JsonHeader और दोनों /erddap/info/dataset पर आईडी .nc OJson and /erddap/info/datasetId/index .nc ओजसन।
@srstavage के लिए धन्यवाद
      * ISO19139_2007 और ISO19115_3_2016 आउटपुट के लिए अतिरिक्त मेटाडाटा गुण: वर्गीकरण, विषय_श्रेणी, और रखरखाव_आवृत्ति
@SethChampagneNRL को धन्यवाद
      * परिवर्तनीय विशेषता सुझावों के लिए नई JSON वेबसर्विस: /erddap/suggestVariableAttributes
@srstavage के लिए धन्यवाद
      * एसक्यूएल समर्थित डेटासेट की बेहतर क्वेरी इसलिए एक अनुरोध जिसमें कोई भी डीबी कॉलम नहीं होता है, अब सफल हो जाएगा।
      * सूचना पाठ में लिंक के लिए बेहतर लिंक डिटेक्शन और ऑटो लिंकिंग।

*    **बातें ERDDAP™ प्रशासकों को जानना और करना चाहिए:** 
      * कई फ़ोल्डर स्तरों और एकाधिक वाइल्डकार्ड सहित जटिल पथ regex के लिए बेहतर समर्थन।
      * अद्यतन निर्भरता

## संस्करण 2.30.0{#version-2300} 
 (2026-04-07 जारी) 

संस्करण v2.30.0 काफी हद तक बग फिक्स पर केंद्रित है, स्थिरता और सुरक्षा के लिए निर्भरता अद्यतन और प्रदर्शन सुधार का परीक्षण करता है।

*    **नई सुविधाएँ और परिवर्तन (उपयोगकर्ताओं के लिए) :** 
      * बढ़ी [क्रोइसैन](https://mlcommons.org/working-groups/data/croissant/) मेटाडाटा संगतता और प्रकट समर्थन सहित [हिंदी](https://pypi.org/project/mlcroissant/) संगतता।
      * लकड़ी की छत के लिए बेहतर समर्थन।

*    **बातें ERDDAP™ प्रशासकों को जानना और करना चाहिए:** 
      * अप्रयुक्त कमांड लाइन टूल और संबद्ध कोड को कोडबेस से हटा दिया गया ताकि तकनीकी ऋण को कम किया जा सके। देखें https://github.com/ERDDAP/erddap/pull/432.
 
      * एक नया फीचर फ्लैग `SynchronousLoading` डिफ़ॉल्ट deferred डेटासेट लोडिंग दृष्टिकोण को ओवरराइड करने के लिए जोड़ा गया है। यह शायद ही कभी जरूरत होना चाहिए, और केवल उन मामलों में उपयोग किया जाता है जहां deferred लोडिंग मुद्दों के कारण होता है। देखें [सुविधा ध्वज पृष्ठ](/docs/server-admin/feature-flags#forcesynchronousloading) विवरण के लिए।
...
इन लोगों / विचारों के लिए लिंक और सीएसएस-केवल छवि टूलटिप के लिए नमूना कोड के लिए धन्यवाद (पर था https://codepen.io/electricalbah/pen/eJRLVd ) और स्थगित छवि लोड हो रहा है (पर था https://varvy.com/pagespeed/defer-images.html )   (हालांकि कोड को उपयोग करने से पहले संशोधित किया गया था ERDDAP ) ।
...
यदि आपने उन टैग को अनुकूलित नहीं किया है, तो कृपया उन्हें अपने सेटअप.xml फ़ाइल से हटा दें। अब उनके पास सभी संदेशों में डिफ़ॉल्ट हैं.xml जो बॉब के डेटासेट को संदर्भित करते हैं ERDDAP™ पर https://coastwatch.pfeg.noaa.gov/erddap/index.html । इसलिए अब आपको अपने विशिष्ट डेटासेट की आवश्यकता नहीं है ERDDAP । यदि आप डिफ़ॉल्ट ओवरराइड करना चाहते हैं, तो कुछ या सभी टैग को अपने सेटअप.xml में कॉपी करें और अपने मूल्यों को बदल दें।
...
संबंधित: वास्तविक \\min, वास्तविक \\max, data\\_min और data\\_max गुण अब deprecated हैं। उपयोग करने के लिए अपने डेटासेट को कन्वर्ट करें actual\\_range इसके बजाय।
    ...
    *    [न्यू: जेसन-एलडी के साथ डाटासेट के सेमनेटिक मार्कअप (JSON लिंक्ड डेटा) ](/docs/server-admin/additional-information#json-ld)   
         ERDDAP™ अब उपयोग [json-ld (JSON लिंक्ड डेटा) ](https://json-ld.org) अपने डेटा सूची और डेटासेट का हिस्सा बनाने के लिए [semantic वेब](https://en.wikipedia.org/wiki/Semantic_Web) , जो टिम Berners-ली का विचार है कि वेब सामग्री को अधिक मशीन पठनीय और मशीन "विरोधी" बनाने के लिए। खोज इंजन ( [विशेष रूप से Google](https://developers.google.com/search/docs/data-types/datasets) ) और अन्य semantic उपकरण खोज और अनुक्रमण को सुविधाजनक बनाने के लिए इस संरचित मार्कअप का उपयोग कर सकते हैं। json-ld संरचित मार्कअप अदृश्य-टू-हंस के रूप में दिखाई देता है&lt;स्क्रिप्ट&gt; पर कोड http://.../erddap/info/index.html वेब पेज (जो एक semantic वेब है [DataCatalog](https://schema.org/DataCatalog) ) और प्रत्येक पर http://.../erddap/info/_datasetID_/index.html वेब पेज (जो एक semantic वेब है [डेटासेट](https://schema.org/Dataset) ) । (आयरलैंड में समुद्री संस्थान के एडम लीडबेटर और रॉब फुलर के लिए विशेष धन्यवाद काम के कठिन हिस्सों को करने के लिए ERDDAP ।) 
...
अब, अनुरोध करने के लिए http .../erddap/version \\_string '\' प्लस ASCII पाठ के एक नंबर और वैकल्पिक प्रत्यय वापस आ जाएगा (कोई स्थान या नियंत्रण वर्ण नहीं) , उदाहरण के लिए, " ERDDAP \\_version \\_string=1.82 \\_JohnsFork। Fork करने वाले लोग इसे EDStatic.erddapVersion बदलकर निर्दिष्ट करेंगे। ऐसा करने का यह तरीका पिछले संस्करणों के लिए समस्याओं का कारण नहीं है ERDDAP । Axiom धन्यवाद (विशेष रूप से, Kyle Wilcox) आयरलैंड के समुद्री संस्थान (विशेष रूप से, रॉब फुलर) ।
    ...
    * BUG FIX: ERDDAP™ अब सदस्यता कार्रवाई को "के साथ शुरू करने की अनुमति देता है https://" । (बॉब ने अपने माथे को थप्पड़ मारा।) जेनिफर Sevadjian के लिए धन्यवाद।
...
देखें https://nvd.nist.gov/vuln/detail/CVE-2016-7051 -- उच्च
...
देखें https://nvd.nist.gov/vuln/detail/CVE-2016-7051 -- उच्च
देखें https://nvd.nist.gov/vuln/detail/CVE-2016-3720 - क्रिटिकल
