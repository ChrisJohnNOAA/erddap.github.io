...
1.  [Для ERDDAP™ v2.29.0+, налаштувати Java 25.](#java) 
З причин безпеки, майже завжди краще використовувати останню версію Java 25.
Будь ласка, завантажте та встановіть останню версію
    [Адоптиум OpenJDK (Темурин) 25 мар (ЛТС) ](https://adoptium.net/temurin/releases/?version=25) й
Для перевірки монтажу, запуску `/javaJreBinDirectory/java -версія` Наприклад,
    `/usr/local/jdk-25.0.1+8/jre/bin/java -версія` й

    ERDDAP™ роботи з Java з інших джерел, але ми рекомендуємо Adoptium, оскільки це основний, орієнтований на громаду,
Безкоштовно (як у пивному та мовному виступі) версія Java 25 пропозицій (безкоштовні оновлення протягом багатьох років минулого випуску) й
З причин безпеки, будь ласка, поновіть свій ERDDAP 's версія Java періодично як нові версії Java 25 стане доступним з Adoptium.

    ERDDAP™ Випробувано і використовується в основному з 25, не іншими версіями. З різних причин ми не тестуємо за допомогою інших версій Java й
     
## Кошик{#tomcat} 
...
який призначений для роботи з Java 25 або новачок. Нижче наведено каталог Tomcat як `домка` й
...
На Linux, Mac і Windows, скачати [ерддапКонтент .zip ](https://github.com/ERDDAP/erddapContent/releases/download/content1.0.1/erddapContent.zip) 
і розпакувати його в `домка` каталог, створення `JavaScript licenses API Веб-сайт` й

__Version 1.0.1, 20683 байтів, MD5=98a8099e7e674da59fe35e9c96efa7b5, від 2025-06-02_
...
4. На Linux, Mac та Windows, __download [ерддап.воєнний](https://github.com/ERDDAP/erddap/releases/download/v2.31.0/ERDDAP-2.31.0.war) __ в `веб-камери` :

__Version 2.31.0, 719,567,541 байтів, MD5=DB0AFDE1F441CA9262CB66291A1110D7 від 2026-08-28__
...
Деякі попередні версії також доступні.
   ...
   *  [2.28.1](https://github.com/ERDDAP/erddap/releases/download/v2.28.1/erddap.war)   (622,676,238 байтів, MD5=48b4226045f950c8a8d69ef9521b9bc9, від 2025-09-05) 
   *  [2.29.0](https://github.com/ERDDAP/erddap/releases/download/v2.29.0/erddap.war)   (706,788,135 байтів, MD5=A5ED0DCC8D46CA27640FFEB8CE4A8560, від 2025-12-15) 
   *  [2.30.0 км](https://github.com/ERDDAP/erddap/releases/download/v2.30.0/ERDDAP-2.30.0.war)   (706,939,121 байти, MD5=CDC4B3D82A20B33A6623B85312F6DC21, від 2026-04-06) 
...
Використовуйте браузер для перегляду http://www.YourServer.org/erddap/status.html.
...
Про нас https://en.wikipedia.org/wiki/Favicon.
