...
```
* Brug `python oversættelse / translat.py` at opdatere oversættelser, hvis det er nødvendigt.
...
* Slet i18n/en-mappen (nødvendig, fordi skrive-translations ikke overskrive en eksisterende fil) og løb `npm løb skrive-translations` for at eksportere den nye fodstreng.
* Rediger dokumentationssiderne (udrulning.md og udrulning.md) .
  * Søg efter \\[ Erddap.war \\]  
  * Kopier de eksisterende oplysninger (lidt omformateret) til listen over tidligere installationer.
  * Ændre de aktuelle udgivelsesoplysninger for erddap. krig på \\[ Erddap.war \\] 
* Kør oversættelserne til dokumentationswebstedet. Det anbefales kun at oversætte sider, der har ændret sig, da dette trin kan være meget langsom.
  * Sørg for, at fodfolkene oversættes med det nye versionsnummer.
