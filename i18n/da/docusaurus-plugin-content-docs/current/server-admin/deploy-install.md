...
4. På Linux, Mac og Windows, __download [Erddap.war](https://github.com/ERDDAP/erddap/releases/download/v2.31.0/ERDDAP-2.31.0.war) __ ind i `Tomcat/webapps` :

__Version 2.31.0, 719,567,541 bytes, MD5=DB0AFDE1F441CA9262CB66291A1110D7, dateret 2026-08-28__
