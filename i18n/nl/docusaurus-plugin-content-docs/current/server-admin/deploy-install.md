...
4. Op Linux, Mac en Windows, __downloaden [erddap.war](https://github.com/ERDDAP/erddap/releases/download/v2.31.0/ERDDAP-2.31.0.war) Naar binnen `tomcat/webapps` :

__Versie 2.11.0, 719,567.541 bytes, MD5=DB0AFDE1F441CA9262CB66291A1110D7, gedateerd 2026-08-28__
