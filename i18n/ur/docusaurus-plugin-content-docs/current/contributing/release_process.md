...
```
* استعمال `[ تصویر کا حوالہ ]` اگر ضرورت پڑی تو ترجمے دوبارہ تعمیر کرنے کے لیے
...
* i18n/en ڈائریکٹری حذف کریں (ضرورت اس لیے ہے کہ لکھنؤ تحریر نہیں کی جائے گی) اور دور دراز ہیں `نپتم رند لکھتے ہیں۔` تاکہ نئے پاؤں والے تاروں کو برآمد کیا جا سکے۔
* دستاویزات کے صفحات مرتب کريں (archive-date= (معاونت) صيانة CS1: لغة غير مدعوم) . .
  * تلاش \\[ ایوارڈ.war \\]  
  * موجودہ معلومات نقل کريں (تھوڑی اصلاح) سابقہ تنصیبات کی فہرست میں۔
  * ایوارڈپ کے لیے حالیہ آزاد معلومات تبدیل کریں جنگ \\[ ایوارڈ.war \\] 
* دستاویزات کی جگہ پر ترجمے چلائیں ۔ یہ مشورہ دیا جاتا ہے کہ صرف ترجمہ شدہ صفحات کو ہی تبدیل کیا جائے کیونکہ یہ قدم بہت سست ہو سکتا ہے۔
  * پیادوں کو نئے ورژن نمبر سے منتقل کیا جاتا ہے۔
