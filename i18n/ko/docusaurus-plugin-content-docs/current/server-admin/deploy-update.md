...
## 다운로드{#download} 
3. 다운로드 [다운로드](https://github.com/ERDDAP/erddap/releases/download/v2.31.0/ERDDAP-2.31.0.war) 으로 _tomcat_/webapps .
     (버전 2.31.0, 719,567,541 바이트, MD5=DB0AFDE1F441CA9262CB66291A1110D7, 날짜 2026-08-28) 
     
## 메시지.xml{#messagesxml} 
4. 
