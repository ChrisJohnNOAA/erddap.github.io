...
## 다운로드{#download} 
3. 다운로드 [다운로드](https://github.com/ERDDAP/erddap/releases/download/v2.31.1/ERDDAP-2.31.1.war) 으로 _tomcat_/webapps .
     (버전 2.31.1, 719,561,982 바이트, MD5=2F6D2B2992B3233CB918B80629A09853, 날짜 2026-09-03) 
     
## 메시지.xml{#messagesxml} 
4. 
