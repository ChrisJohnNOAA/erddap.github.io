...
```
* tástálacha Rith a dhéanamh nuashonruithe spleáchas cinnte nach raibh aon rud a bhriseadh do gach cumraíochtaí móra (datasets parsáil go háirithe, cé aon suímh suntasacha eile chomh maith) . Tabhair faoi deara gur féidir leis an tsraith tástála seachtrach a bheith an-flaky. Is féidir leis an tsraith tástála mallAWS an-fhada a ghlacadh.
```
mvn verify
...
cineál gas: in airde ../content/erddap/erddap2.22.war erddap.war / / nó is cuma cad é an uimhir
  * I \\[ taiseachas aeir: fliuch \\] / i / :
./startup.sh
  * Tar éis an ERDDAP Tá ar ais leathanach gréasáin, i \\[ taiseachas aeir: fliuch \\] / iarratais / :
...
Go raibh maith agat as úsáid ERDDAP .
