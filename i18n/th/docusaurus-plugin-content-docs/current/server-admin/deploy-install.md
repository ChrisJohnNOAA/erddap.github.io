...
1.  [สําหรับ ERDDAP™ v2.29. 0+, ตั้ง Java 25](#java) 
ด้วยเหตุผลด้านความปลอดภัย ที่จะใช้รุ่นล่าสุด Java 25
โปรดดาวน์โหลดและติดตั้งรุ่นล่าสุดของ
    [รับเลี้ยงบุตรบุญธรรมของ OpenJDK (เตมู ริน) 25 (LTS) ](https://adoptium.net/temurin/releases/?version=25) .
เพื่อตรวจสอบการติดตั้ง ให้ทํางาน `จาวา จิน ดิเรกตี้/จาวา กลับหัว` ตัวอย่างเช่น
    `/usr/local/jdk-25.1+8/jre/bin/java กลับหัว` .

    ERDDAP™ ทํางานกับ Java จากแหล่งอื่น แต่เราแนะนําให้รับบุตรบุญธรรม เนื่องจากมันเป็นหลัก
ว่าง (เช่นเบียร์และการพูด) รุ่น Java 25 ที่ให้การสนับสนุนระยะยาว (ปรับรุ่นฟรีเป็นเวลาหลายปีที่ผ่านมา ออกครั้งแรก) .
ด้วยเหตุผลความปลอดภัย โปรดแจ้งความคืบหน้า ERDDAP รุ่นของ Java เป็นรุ่นใหม่ของ Java 25 เปิดรับจากสถานรับเลี้ยงบุตรบุญธรรม พ.ศ.

    ERDDAP™ เคย มี การ ทดสอบ และ ใช้ อย่าง กว้าง ขวาง กับ 25 ฉบับ ไม่ ใช่ ฉบับ แปล อื่น. ด้วยเหตุผลบางอย่าง เราไม่ทดสอบหรือสนับสนุนเวอร์ชันอื่น Java .
     
## ทอมแคท{#tomcat} 
...
ซึ่งถูกออกแบบมาให้ทํางานกับ Java 25 หรือใหม่กว่า ด้านล่างนี้ จะอ้างถึงไดเรกทอรี Tomcat เป็น `แว่นขยาย` .
...
* บริบท. xml -- แคชของทรัพยากร - อยู่ใน `Tomcate/conf/ Context. xml` ก่อน ` </Context> ` ป้ายกํากับ, เปลี่ยนป้ายกํากับทรัพยากร
...
* ดูปูมบันทึกของ Tomcat `Tomcate/logs/catalina. ออก` . ปัญหาเกี่ยวกับทอมแคทและบางอย่าง ERDDAP™ โจทย์เริ่มต้น มักจะระบุตรงนั้นเสมอ
...
บนลินุกซ์, Mac และวินโดวส์, ดาวน์โหลด [แก้ไขโครงการหลัก... .zip ](https://github.com/ERDDAP/erddapContent/releases/download/content1.0.1/erddapContent.zip) 
และปลดมันออก `แว่นขยาย` ไดเรกทอรี, การสร้าง `Tomcat/ Content/ perdap` .

_Version 1. 0.1, 20683 bytes, MD5 =98a8099E7E674da59f59c967b5, ลงวันที่ 2025-06-02_BAR_
...
ฉบับ แปล บาง ฉบับ ก่อน หน้า นี้ มี อยู่ ด้วย.
   ...
   *  [2.28.1](https://github.com/ERDDAP/erddap/releases/download/v2.28.1/erddap.war)   (622,676,238 ไบต์, MD5 =48b4226045950.8-90999099191919211b9c9, ลงวันที่ 2025-09-05.) 
   *  [2.29.0.](https://github.com/ERDDAP/erddap/releases/download/v2.29.0/erddap.war)   (706,788,135 ไบต์, MD5=A5EDEDDDCS84848484848FE484848484860, ลงวันที่ 2025-12-15.) 
   *  [2.30.0.](https://github.com/ERDDAP/erddap/releases/download/v2.30.0/ERDDAP-2.30.0.war)   (706,939,121 ไบต์, MD5=CDC4B3DB3A20484831-2323B853F6DC21, ลงวันที่ 2026-04-06.) 
...
ดู https://en.wikipedia.org/wiki/Favicon.
