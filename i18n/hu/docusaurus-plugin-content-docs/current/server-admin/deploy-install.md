...
4. Linux, Mac és Windows, __download [erddap.war](https://github.com/ERDDAP/erddap/releases/download/v2.31.0/ERDDAP-2.31.0.war) Belépés `Tomcat/webapps` :

__Version 2.31.0, 719.567.541 bytes, MD5=DB0AFDE1F441CA9262CB66291A1110D7, dátumozott 2026-08-28__
...
Néhány korábbi verzió is elérhető.
   ...
   *  [2.29.0](https://github.com/ERDDAP/erddap/releases/download/v2.29.0/erddap.war)   (706,788,135 bytes, MD5=A5ED0DCC8D46CA27640FFEB8CE4A8560, 2025-12-15) 
   *  [2.30.0](https://github.com/ERDDAP/erddap/releases/download/v2.30.0/ERDDAP-2.30.0.war)   (706 939 121 byte, MD5=CDC4B3D82A20B33A6623B85312F6DC21, 2026-04-06) 
