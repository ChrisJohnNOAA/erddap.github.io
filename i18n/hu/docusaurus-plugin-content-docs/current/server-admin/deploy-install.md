...
4. Linux, Mac és Windows, __download [erddap.war](https://github.com/ERDDAP/erddap/releases/download/v2.31.1/ERDDAP-2.31.1.war) Belépés `Tomcat/webapps` :

__Version 2.31.1, 719,561,982 bytes, MD5=2F6D2B2992B3233CB918B80629A09853, dátumozott 2026-09-03__
