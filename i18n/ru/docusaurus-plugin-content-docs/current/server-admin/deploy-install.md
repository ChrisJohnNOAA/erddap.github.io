...
1.  [Для ERDDAP™ v2.29.0+, установить Java 25.](#java) 
По соображениям безопасности почти всегда лучше использовать последнюю версию. Java 25.
Пожалуйста, загрузите и установите последнюю версию
    [Открытый JDK (Темурин) 25 (LTS) ](https://adoptium.net/temurin/releases/?version=25) .
Чтобы проверить установку, запустите `/javaJreBinDirectory/java инверсия` Например,
    `/usr/local/jdk-25.0.1+8/jre/bin/java инверсия` .
...
свободный (Как в пиве и речи) версия Java 25, которые предлагают долгосрочную поддержку (Бесплатные обновления в течение многих лет после первоначального выпуска) .
По соображениям безопасности, пожалуйста, обновите ERDDAP версия Java периодически в виде новых версий Java 25 становятся доступными из Adoptium.

    ERDDAP™ Он был протестирован и широко использовался в 25 версиях. По разным причинам мы не тестируем и не поддерживаем другие версии. Java .
     
## Томкат{#tomcat} 
...
который предназначен для работы с Java 25 или больше. Ниже каталог Tomcat будет называться `кот` .
...
На Linux, Mac и Windows, скачать [erddapContent .zip ](https://github.com/ERDDAP/erddapContent/releases/download/content1.0.1/erddapContent.zip) 
и разъединить его в `кот` каталог, создавая `Tomcat/content/erddap` .

__Версия 1.0.1, 20683 байт, MD5=98a8099e7e674da59fe35e9c96efa7b5, от 2025-06-02__
...
4. Linux, Mac и Windows, __download [erddap.war](https://github.com/ERDDAP/erddap/releases/download/v2.31.1/ERDDAP-2.31.1.war) ___ в `Tomcat/webapps` :

__Версия 2.31.1, 719,561,982 байт, MD5=2F6D2B2992B3233CB918B80629A09853, датированная 2026-09-03__
...
Также доступны некоторые предыдущие версии.
   ...
   *  [2.28.1](https://github.com/ERDDAP/erddap/releases/download/v2.28.1/erddap.war)   (622 676 238 байт, MD5=48b4226045f950c8a8d69ef9521b9bc9, от 2025-09-05) 
   *  [2.29.0](https://github.com/ERDDAP/erddap/releases/download/v2.29.0/erddap.war)   (706 788 135 байт, MD5=A5ED0DCC8D46CA27640FFEB8CE4A8560, от 2025-12-15) 
   *  [2.30.0](https://github.com/ERDDAP/erddap/releases/download/v2.30.0/ERDDAP-2.30.0.war)   (706 939 121 байт, MD5=CDC4B3D82A20B33A6623B85312F6DC21, от 2026-04-06) 
...
Используйте браузер, чтобы попытаться просмотреть http://www.YourServer.org/erddap/status.html.
