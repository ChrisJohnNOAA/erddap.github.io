...
* Slett i18n/en-katalogen (nødvendig fordi skrive-translasjoner ikke vil overskrive en eksisterende fil) og løp `npm kjøre skrive-translasjoner` å eksportere den nye bunnstrengen.
* Rediger dokumentasjonssidene (implementer-install.md og implementer-update.md) ..
  * Søk etter \\[ Erddap.war \\]  
  * Kopier eksisterende informasjon (litt misfarging) til listen over tidligere installasjoner.
  * Endre gjeldende utgivelsesinformasjon for Erddap. krig i \\[ Erddap.war \\] 
* Kjør oversettelsene for dokumentasjonssiden. Det anbefales bare å oversette sider som har endret seg siden dette trinnet kan være veldig sakte.
  * Pass på at bunntekstene oversettes med det nye versjonsnummeret.
